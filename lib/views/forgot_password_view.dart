        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            ...
            await showErrorDialog(
              context,
              'We could not process your request. Please make sure that you are a registered user, or if not, registre a user now by going back one step',
            );
          }
        }
      },
