...
void main() {
  group('Mock Authentification', () {
    ...
    test('Should be able ti initialize in less than 2 seconds', () async {
      await provider.initialize();
      expect(provider.isInitialized, true);
    ...
    test('Create user should delegate to logIn function', () async {
      ...
      expect(
        badEmailUser,
        throwsA(
          const TypeMatcher<UserNotFoundAuthExceptions>(),
        ),
      );
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({required String email, required String password}) {
    ...
    const user = AuthUser(id: 'my_id',email: 'foo@bar.com', isEmailVerified: false,);
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(id: 'my_id', email: 'foo@bar.com', isEmailVerified: true);
    _user = newUser;
  }
}
